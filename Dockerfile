...
RUN cd $GOPATH/src/github.com/alvaradojl/go4microservice2azurekvbyenv/cmd/keyvault
...
FROM scratch
WORKDIR /app
COPY --from=build-env $GOPATH/src/github.com/alvaradojl/go4microservice2azurekvbyenv/cmd/keyvault/keyvaultapp .
